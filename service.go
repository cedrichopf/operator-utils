...
// ReconcileService takes a Service and creates or updates it on a Kubernetes cluster. It will generate a
// revision hash that will be added to the object as a label and add the controller reference to the given
// owner object.
//
// A successful ReconcileService returns a ReconcileResult and nil.
// A failed ReconcileService returns an empty ReconsileResult and an error.
